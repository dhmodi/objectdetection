...
class FeatureDriver():
    ...
    def match_images(image1, image2):
        ...
        orb = cv2.ORB_create(1000000, 1.2, nlevels=8, edgeThreshold = 5, scoreType=cv2.ORB_FAST_SCORE)
        ...
        print("Final Goodness - " + str(good_score))
        print("Final Average - " + str(good_score/n_clusters_))
        return (good_score/n_clusters_)